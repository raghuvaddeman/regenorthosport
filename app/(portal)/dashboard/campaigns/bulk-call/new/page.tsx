...
export default function NewBulkCallCampaignPage() {
  ...
  const canSubmit = name.trim() && selectedTrunkId && contacts.length > 0 && !submitting;
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Set up a new bulk call campaign.</p>
      </div>
      ...
      <div className="rounded-2xl border border-zinc-200/70 bg-white p-6 shadow-sm ring-1 ring-black/[0.02] dark:border-zinc-700 dark:bg-zinc-800 dark:ring-white/[0.02]">
        ...
        <p className="mt-0.5 text-xs text-zinc-400">Enter a name for your bulk call campaign.</p>
        <input
          type="text"
          value={name}
          onChange={(e) => setName(e.target.value)}
          placeholder="e.g. Knee clinic follow-up, July 2026"
          className="mt-3 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:border-zinc-600 dark:bg-zinc-900"
        />
      </div>
      ...
      <div className="rounded-2xl border border-zinc-200/70 bg-white p-6 shadow-sm ring-1 ring-black/[0.02] dark:border-zinc-700 dark:bg-zinc-800 dark:ring-white/[0.02]">
        ...
        <input
          ...
          className="mt-3 w-32 rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:border-zinc-600 dark:bg-zinc-900"
        />
      </div>
