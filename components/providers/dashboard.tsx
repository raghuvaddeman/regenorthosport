...
const inputClasses =
  "w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-400 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white dark:placeholder:text-zinc-600";
...
export default function ProviderManagementDashboard() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      {/* Category tabs */}
      <div className="mb-6 flex flex-wrap gap-1.5 rounded-xl border border-zinc-200 bg-zinc-50 p-1.5 dark:border-zinc-600 dark:bg-zinc-700">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white dark:border-zinc-600 dark:bg-zinc-700">
          <div className="border-b border-zinc-200 p-3 dark:border-zinc-600">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-md border border-zinc-200 bg-zinc-50 py-1.5 pl-8 pr-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none dark:border-zinc-600 dark:bg-zinc-800 dark:text-white"
              />
            </div>
          </div>
                    ...
                    <span className="flex items-center gap-2 font-medium text-zinc-800 dark:text-zinc-100">
                      <span
                        className={`h-1.5 w-1.5 rounded-full ${
                          isConnected ? "bg-emerald-500" : "bg-zinc-300 dark:bg-zinc-500"
                        }`}
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-600 dark:bg-zinc-700">
          {!selectedMeta ? (
