        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full rounded-md border border-zinc-200 bg-white pl-9 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-zinc-800 dark:bg-zinc-950"
            />
          </div>
          <select
            value={minRating}
            onChange={(e) => setMinRating(e.target.value)}
            className="rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-zinc-800 dark:bg-zinc-950"
          >
      ...
      <div className="rounded-xl border border-zinc-200 bg-white overflow-hidden dark:border-zinc-800 dark:bg-zinc-950">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-sm">
            <thead>
              <tr className="border-b border-zinc-200 bg-zinc-50/70 text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900/50">
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
              {loading && filteredCalls.length === 0 ? (
                ...
                filteredCalls.map((c) => {
                  ...
                  return (
                    <tr key={c.uuid} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-900/30">
                      ...
                      <td className="p-4 text-right">
                        <button
                          ...
                          className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-zinc-100 text-zinc-700 hover:bg-zinc-200 disabled:opacity-30 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                        >
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="w-full bg-zinc-100 h-3 rounded-full dark:bg-zinc-800 overflow-hidden">
...
export function SettingsView() {
  return (
    <div className="max-w-2xl space-y-8">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white divide-y divide-zinc-200 dark:border-zinc-800 dark:bg-zinc-950 dark:divide-zinc-800">
        ...
        <div className="flex items-start gap-4 p-5 bg-zinc-50/50 dark:bg-zinc-900/10">
